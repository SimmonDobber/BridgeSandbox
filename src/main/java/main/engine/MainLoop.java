...
public class MainLoop implements Runnable
{
    ...
    List<State> gameObjects = new LinkedList<>();
...
//        gameObjects.forEach(state -> state.gameupdate());
//        gameObjects.forEach(State::render);
    ...
    public void addGameObject(State gameObject) {
